 ...
 * 
 */
@WebServiceClient(name = "MyServiceService", targetNamespace = "http://service.service.web.codingob.github.com/", wsdlLocation = "http://localhost:8080/myservice/data?wsdl")
    ...
    extends Service
{
    ...
    private final static QName MYSERVICESERVICE_QNAME = new QName("http://service.service.web.codingob.github.com/", "MyServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/myservice/data?wsdl");
    ...
    public MyService getMyServicePort() {
        return super.getPort(new QName("http://service.service.web.codingob.github.com/", "MyServicePort"), MyService.class);
    }
    ...
    public MyService getMyServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.service.web.codingob.github.com/", "MyServicePort"), MyService.class, features);
    }
